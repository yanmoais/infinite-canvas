...
export type ComfyExtraConfig = {
    ...
    seam_feather?: number;
    /** 原图续接方向：up/down/left/right/outward，供网关做方向级正负向清洗 */
    outpaint_direction?: string;
};
...
export type UiModelCapability = ModelCapability;
...
export function guessCapability(name: string): ModelCapability {
    ...
    if (value.startsWith("comfy/")) return "image";
...
export function selectableModelsByCapability(config: AiConfig, capability?: UiModelCapability) {
